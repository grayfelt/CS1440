...
if __name__ == '__main__':
    ...
    # This setup of main breaks pycharms Unittest Configuration setup
    # However, I think an easy fix exists, in which I make sure I can utilize
    # `python -m unittest ...` on this file.
    # Only output from message from Pycharms Unittest Configuration:
    # #####
    # Launching unittests with arguments python -m unittest C:/Users/jjwin/Documents/USU/Sum20/cs1440-dev/assn0/lsn/0-ASCIIChars/runTests.py in C:\Users\jjwin\Documents\USU\Sum20\cs1440-dev\assn0\lsn\0-ASCIIChars
